...
function About() {
  return (
    <>
      <Fragment>
        <div
          className="py-2 container-xxl wow animate__fadeInDownBig "
          data-wow-delay="0.1s"
        >
          <section class="py-3 py-md-2 py-xl-4">
            <div class="container">
                  ...
                  <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                      ...
                      <p class="mb-5">
                        ...
                        lacinia arcu ex, sed pharetra nibh porta a. Curabitur
                        vel consequat nibh, ac interdum nisl. Nunc pulvinar nec
                        massa vitae sollicitudin.
                      </p>
        ...
        <section class="py-3 py-md-5 py-xl-3 wow fadeIn " data-wow-delay="0.4s">
          <div class="container">
                  ...
                  <div class="row gy-3 gy-md-0 align-items-md-center">
                    ...
                    <div class="col-md-7">
                      <div class="card-body p-0">
                        <h2 class="card-title h4 mb-3">Who Are We?</h2>
                        <p class="card-text lead">
                          With years of experience and deep industry knowledge,
                          we have a proven track record of success and are
