  ...
  return (
    <Fragment>
      ...
      <div
        className={`${
          data.editProductModal.modal ? "" : "hidden"
        } fixed inset-0 pt-5 flex items-center z-30 justify-center overflow-auto`}
      >
        <div className="mt-29 pt-5 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-6">
          <div className="flex items-center justify-between w-full pt-4">
            <span className="text-left text-success font-semibold mt-5 text-2xl tracking-wider">
              Update Product
            </span>
            <FaWindowClose   onClick={(e) =>
                dispatch({ type: "editProductModalClose", payload: false })
              } className="w-10 text-success mt-5   h-10" />
          </div>
