    ...
    <Fragment>
      <div className="grid grid-cols-2 md:grid-cols-1">
        {products.length > 0 ? (
            ...
            return (
              ...
              >
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  <div
                    onClick={(e) => history.push(`/products/${product._id}`)}
                    className="inline-block px-4 py-2 text-white bg-success text-xs md:text-base text-center cursor-pointer hover:opacity-75"
                  >
                    Open
                  </div>
                </div>
          ...
          <div> <h1>No product found in wishList</h1></div>
        )}
      </div>
    </Fragment>
  );
